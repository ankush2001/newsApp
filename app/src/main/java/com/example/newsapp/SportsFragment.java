...
public class SportsFragment extends Fragment {
    ...
    private String categorySports="sports";

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.sportsfragment,null);
        recyclerViewSport = view.findViewById(R.id.recycleViewSports);
    ...
    private void findNews() {
        ApiUtilities.getApiInterface().getCategoryNews(country,categorySports,100,api).enqueue(new Callback<MainNews>() {
            @Override
