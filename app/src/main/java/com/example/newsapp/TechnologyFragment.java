...
public class TechnologyFragment extends Fragment {
    ...
    private String categoryTechnology="technology";

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.technologyfragment,null);
        recyclerViewTechnology = view.findViewById(R.id.recycleViewTechnology);
    ...
    private void findNews() {
        ApiUtilities.getApiInterface().getCategoryNews(country,categoryTechnology,100,api).enqueue(new Callback<MainNews>() {
            @Override
